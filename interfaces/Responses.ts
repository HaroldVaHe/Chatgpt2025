...
export class Convert {
    public static toWelcome(json: string): APIresponse {
        return cast(JSON.parse(json), r("APIresponse"));
    }

    public static welcomeToJson(value: APIresponse): string {
        return JSON.stringify(uncast(value, r("APIresponse")), null, 2);
    }
}
